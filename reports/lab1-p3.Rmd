...
#1. Quanto maior o numero de temporadas, maior a média de avaliação de uma série?
...
#Comentários
  ...
  Texto muito bom, parabéns! O raciocínio utilizado para responder foi bem distinto e a maneira que ele foi escrito ajuda muito a assimilar bem o conteúdo produzido. Como sugestão, você poderia explicar um pouco mais alguns conceitos matemáticos/estatísticos, como quartis e correlação. Também notei que a resolução de algumas perguntas não produziram novas perguntas que foram respondidas. Ótimo trabalho!